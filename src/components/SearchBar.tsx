...
export function SearchBar({ onSearch }: SearchBarProps) {
  ...
  return (
    <div className="bg-[#191919] box-border content-stretch flex flex-col gap-4 md:gap-[20px] items-start justify-center p-4 md:p-[20px] relative rounded-[20px] md:rounded-[30px] shrink-0">
      {/* Main Search Bar */}
      <div className="bg-[#f9f8f8] box-border content-stretch flex flex-col md:flex-row md:flex-wrap gap-3 md:gap-[20px] items-stretch md:items-center justify-center p-3 md:p-[20px] relative rounded-[20px] md:rounded-[30px] shrink-0 w-full">
        {/* Search Input */}
        <div className="bg-[#f9f8f8] box-border content-stretch flex gap-3 md:gap-[20px] items-center justify-center p-3 md:p-[20px] relative rounded-[20px] md:rounded-[30px] shrink-0 flex-1 min-w-0 md:min-w-[200px]">
          <div className="relative shrink-0 size-6 md:size-[40px]">
        ...
        {/* Divider */}
        <div className="hidden lg:flex h-[57px] items-center justify-center relative shrink-0 w-0">
        ...
        {/* Location Input */}
        <div className="bg-[#f9f8f8] box-border content-stretch flex gap-3 md:gap-[20px] items-center justify-center p-3 md:p-[20px] relative rounded-[20px] md:rounded-[30px] shrink-0 flex-1 min-w-0 md:min-w-[180px]">
          <div className="relative shrink-0 size-6 md:size-[40px]">
        ...
        <div className="bg-[#f9f8f8] box-border content-stretch flex gap-3 md:gap-[20px] items-center justify-center p-3 md:p-[20px] relative rounded-[20px] md:rounded-[30px] shrink-0 cursor-pointer hover:bg-gray-100 transition-colors">
          <span className="leading-[normal] not-italic relative shrink-0 text-[#191919] text-sm md:text-[18px] text-nowrap whitespace-pre">
            {serviceType}
          </span>
          <div className="relative shrink-0 size-6 md:size-[40px]">
        ...
        >
          <span className="leading-[normal] not-italic relative shrink-0 text-sm md:text-[18px] text-nowrap whitespace-pre">
            Rechercher
          </span>
        </button>
      </div>
      ...
      {/* Filter Buttons */}
      <div className="content-stretch flex gap-3 md:gap-[30px] items-center relative shrink-0 flex-wrap">
        <button className="bg-[#191919] box-border content-stretch flex gap-3 md:gap-[20px] items-center justify-center p-3 md:p-[20px] relative rounded-[20px] md:rounded-[30px] shrink-0 border border-[#f9f8f8] hover:bg-[#f9f8f8] hover:text-[#191919] transition-colors">
          <div className="relative shrink-0 size-6 md:size-[40px]">
          ...
          <span className="leading-[normal] not-italic relative shrink-0 text-[#f9f8f8] text-sm md:text-[18px] text-nowrap whitespace-pre">
            Filtres
          </span>
        </button>
