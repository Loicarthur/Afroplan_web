  ...
  return (
    <>
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="container mx-auto px-4 md:px-8 py-4 md:py-6 max-w-[1400px]">
            ...
            <div className="md:hidden mt-6 pb-4 border-t border-gray-100 pt-4">
              {user ? (
                ...
                <nav className="flex flex-col gap-4">
                  ...
                  <button 
                    onClick={() => openAuthModal('login')}
                    className="bg-[#191919] px-6 py-3 rounded-[30px] text-white border border-[#191919] w-full mt-4"
                  >
                    Connexion
                  </button>
                </nav>
