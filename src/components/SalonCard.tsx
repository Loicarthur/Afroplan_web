...
export function SalonCard({ salon, onClick }: SalonCardProps) {
  return (
    ...
    >
      <div className="box-border content-stretch flex flex-col gap-3 md:gap-[20px] h-full items-start pb-3 md:pb-[20px] pt-0 px-0 relative shrink-0 w-full">
        {/* Image */}
        ...
        <div className="relative shrink-0 w-full">
          <div className="size-full">
            <div className="box-border content-stretch flex flex-col gap-3 md:gap-[20px] items-start p-2 md:p-[10px] px-3 md:px-4 relative w-full">
              {/* Name and Location */}
              <div className="content-stretch flex flex-col gap-1 md:gap-[5px] items-start relative shrink-0 w-full">
                <h3 className="leading-[normal] not-italic relative shrink-0 text-[#191919] text-lg md:text-[22px] truncate max-w-full">
                  {salon.name}
                </h3>
              ...
              <div className="content-stretch flex gap-2 md:gap-[10px] items-center relative shrink-0 flex-wrap">
                {salon.tags.map((tag, index) => (
                  ...
                  >
                    <span className="leading-[normal] not-italic relative shrink-0 text-[#191919] text-xs md:text-[14px]">
                      {tag}
                    </span>
                  </div>
                ))}
